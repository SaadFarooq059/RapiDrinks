...
const SERVICES = [
  {
    ...
    description:
      "Access over 1,200 carefully curated beverages from world-renowned vineyards, distilleries, and breweries. From rare vintages to craft favorites.",
    image:
      "/whyus1.png",
  },
  {
    ...
    description:
      "Next-day delivery across Belgium with same-day options in Brussels. Temperature-controlled logistics ensure your drinks arrive in perfect condition.",
    image:
      "/whyus2.png",
  },
  {
    ...
    description:
      "Competitive B2B pricing with volume discounts. Transparent pricing, no hidden fees, and flexible payment terms for established partners.",
    image:
      "/whyus1.jpg",
  },
];
      ...
      <div className="w-full px-4 md:px-8 lg:px-12 xl:px-20 mx-auto">
        <div className="mb-12 text-center">
          <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-foreground">
            Why Choose Rapid Drinks?
          </h2>
          <p className="mt-3 text-sm sm:text-base md:text-lg text-muted-foreground leading-relaxed">
            Built for reliability, quality, and efficient wholesale operations.
          </p>
        </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-2 flex-1">
                      <span
                        className={cn(
                          "text-2xl md:text-3xl lg:text-4xl font-serif font-semibold tracking-tight transition-colors duration-500",
